...
lmax       = 600 # maximum multipole for T, E, B and \phi.
nx         = 512  # number of pixels for flat-sky calc.
dx         = 1./60./180.*np.pi # pixel width in radians.

nlev_p1     = 2.8    # polarization noise level, in uK.arcmin.
nlev_p2     = 2.8
...
ATT       = 2.0533903*20
AEE       = 4.547901 * 10**(-4)*20
ABB       = 2.3831 * 10**(-4)*20

beam_fwhm1  = 20.96  # Gaussian beam full-width-at-half-maximum.
beam_fwhm2  = 28.26

fsky       = 0.015


data=np.loadtxt('data600.txt')
